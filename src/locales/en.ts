const en = {
  ...
  options: {
    ...
    newOption: "New Option Trade",
    editOption: "Edit Option Trade",
    addOption: "Add Option",
    addFirst: "Add your first option trade",
    noRecords: "No option trades yet.",
    searchSymbol: "Search symbol",
    ...
    saveChanges: "Save changes",
    saving: "Saving...",
    created: "Option trade created",
    updated: "Option trade updated",
    deleted: "Option trade deleted",
    saveFailed: "Failed to save",

    errorSymbol: "Symbol is required",
    errorStrike: "Strike price is required",
    errorExpiration: "Expiration date is required",
    errorTradeDate: "Trade date is required",
    errorQuantity: "Quantity must be greater than 0",
    errorPremium: "Premium must be greater than 0",
  },
} as const;
