const en = {
  // ── Auth ────────────────────────────────────────────────────
  auth: {
    subtitle: "Taiwan Stock Trading Journal",
  ...
  trade: {
    ...
    metadataOnlyWarning: "This trade has been matched or is a sell trade. Only stop loss, take profit, and notes can be modified. Delete and recreate to change core fields.",
    market: "Market",
    ...
    takeProfit: "Take Profit (TWD)",
    stopLossDistance: "{{pct}}% from avg",
    takeProfitDistance: "+{{pct}}% from avg",
