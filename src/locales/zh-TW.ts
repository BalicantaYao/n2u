const zhTW = {
  ...
  positions: {
    ...
    suggestedStopLossTip: "近 14 日開／收盤最高價 − 2 × ATR(14)，括號為參考日",
    ma5: "5日均線",
    ma10: "10日均線",
  ...
  observations: {
    title: "每日觀察",
    subtitle: "每天提醒你逐筆確認這些標的，打勾後隔天自動重置。",
    dailyTitle: "今日待確認",
    manage: "管理",
    add: "加入",
    addToDaily: "加入每日觀察",
    ...
    updateFailed: "更新失敗",
    deleteFailed: "刪除失敗",
    notePlaceholder: "要確認什麼？例如：觀察是否站回月線、留意爆量…",
    noNote: "（尚無確認筆記）",
    done: "完成",
    checkedToday: "今日已確認",
    allDone: "今日確認完成，做得好！",
    archive: "封存",
    unarchive: "取消封存",
    confirmDelete: "確定要刪除這個觀察標的嗎？",
    showArchived: "查看已封存",
    showActive: "查看進行中",
    empty: "目前沒有每日觀察標的，可從「交易成果」頁加入。",
    emptyArchived: "沒有已封存的觀察標的。",
  },
